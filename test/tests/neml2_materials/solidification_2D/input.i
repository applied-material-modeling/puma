...
[NEML2]
    input = '../../../../neml2_models/aoti/solidification_2d/model_aoti.i'
    [all]
        model = 'model'
        verbose = true
        device = 'cpu'

        # Inputs/outputs auto-map by name: phif, T -> VARIABLE; t -> TIME;
        # deformation_gradient, phis, phip, phif_s(old ~1) -> MATERIAL. Derivatives
        # alias the NEML2 (output input) pair to the MOOSE property the kernels read.
